...
// import wasm from './eigen_gen.wasm' // Comment out for local testing
// import GarbageCollector, { getStaticMethods } from './GarbageCollector.mjs'

// wasm().then((exports) => console.log(exports));
...
eig.ready = Module().then(module => {
  ...
  classes.forEach(className => {
    eig[className] = GarbageCollector.initClass(classes, module[className])
  })
  addHelpers(eig);
})
